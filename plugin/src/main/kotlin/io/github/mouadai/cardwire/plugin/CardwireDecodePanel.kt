...
import io.github.mouadai.cardwire.core.input.HexDump
...
import io.github.mouadai.cardwire.core.iso.DialectEntry
 ...
 */
class CardwireDecodePanel(private val dialectSources: () -> List<DialectSource> = { emptyList() }) {
