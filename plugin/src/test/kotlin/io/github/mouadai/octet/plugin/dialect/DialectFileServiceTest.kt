...
class DialectFileServiceTest : BasePlatformTestCase() {
    ...
    fun testPathRules() {
        assertTrue(DialectLocations.affectsDialects("/work/app/.octet/dialects/acme.json"))
        assertTrue(DialectLocations.affectsDialects("/work/app/.octet/dialects"))
        assertTrue(DialectLocations.affectsDialects("/work/app/.octet"))
        assertTrue(DialectLocations.affectsDialects(DialectLocations.userDir().resolve("mine.json").toString()))
        assertFalse(DialectLocations.affectsDialects("/work/app/.octet/dialects/sub/acme.json"))
        assertFalse(DialectLocations.affectsDialects("/work/app/dialects/acme.json"))
        assertFalse(DialectLocations.affectsDialects("/work/app/.octet/dialects/acme.yaml"))
    }
}
