package io.github.mouadai.cardwire.core
...
/**
 * Cardwire must never touch the network (SPEC section 5). This test fails if any compiled class or
...
class NoNetworkTest {
    ...
    fun `compiled core classes reference no networking APIs`() {
        val classFiles = System.getProperty("cardwire.core.mainClasses")
    ...
    fun `core sources import no networking APIs`() {
        val sources = File(System.getProperty("cardwire.core.mainSources"))
            .walkTopDown()
