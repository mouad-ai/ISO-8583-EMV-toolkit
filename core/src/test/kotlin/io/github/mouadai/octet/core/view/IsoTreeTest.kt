...
import io.github.mouadai.octet.core.iso.LengthPrefix
...
class IsoTreeTest {
    ...
    private fun encode(dialect: io.github.mouadai.octet.core.iso.Dialect, framing: FramingSpec = FramingSpec.NONE): ByteArray =
        (IsoEncoder.encode(data, dialect, framing) as EncodeResult.Success).bytes

    private fun view(bytes: ByteArray, dialect: io.github.mouadai.octet.core.iso.Dialect = ascii87, reveal: Boolean = false) =
