...
class ReferenceTables(currencies: Collection<Currency>, countries: Collection<Country>) {
    ...
    companion object {
        val default: ReferenceTables by lazy {
            val currencies = JsonResources.load("/cardwire/emv/iso4217.json").asArray("iso4217").map {
            ...
            val countries = JsonResources.load("/cardwire/emv/iso3166.json").asArray("iso3166").map {
