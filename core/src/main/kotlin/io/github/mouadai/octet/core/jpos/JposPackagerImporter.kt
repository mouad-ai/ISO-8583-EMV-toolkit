...
import io.github.mouadai.octet.core.emv.JsonResources
import io.github.mouadai.octet.core.emv.asObject
import io.github.mouadai.octet.core.iso.Dialect
import io.github.mouadai.octet.core.iso.DialectJsonWriter
import io.github.mouadai.octet.core.iso.DialectLoadResult
import io.github.mouadai.octet.core.iso.DialectLoader
...
/**
 * Converts a jPOS `GenericPackager` XML file into an Octet dialect (SPEC 7, M6). Field classes are
 * mapped with the table in `octet/jpos/jpos-field-classes.json`; a class missing from it becomes a
...
object JposPackagerImporter {
    ...
    private val classTable: Map<String, ClassMapping> by lazy {
        JsonResources.load("/octet/jpos/jpos-field-classes.json").asObject("jPOS class table")["classes"]
    ...
    private class Converter(val warnings: MutableList<String>, val errors: MutableList<String>) {
        ...
        fun field(el: Element, number: Int, path: String, topLevel: Boolean): Map<String, Any?>? {
            ...
            // jPOS numeric classes carry track data with its '=' or 'D' separator; Octet types it z.
