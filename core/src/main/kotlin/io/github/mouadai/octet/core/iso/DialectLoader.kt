...
/** The generic dialects bundled with Octet (SPEC 7), read from JSON resources. */
object BuiltinDialects {
    ...
    fun json(id: String): String? {
        ...
        val stream = BuiltinDialects::class.java.getResourceAsStream("/io/github/mouadai/octet/core/dialects/$id.json") ?: return null
